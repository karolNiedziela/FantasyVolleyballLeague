        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlayerStatistics_Match_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTeamPlayer", x => new { x.UserTeamId, x.PlayerId });
                    table.ForeignKey(
                        name: "FK_UserTeamPlayer_Player_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Player",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserTeamPlayer_UserTeam_UserTeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTeamPlayer_PlayerId",
                table: "UserTeamPlayer",
                column: "PlayerId");
        }
